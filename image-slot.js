  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">ou <u>choisir un fichier</u></div></div>' +
        ...
        '<div class="ctl" popover="manual" data-dc-edit-transparent><button data-act="replace" title="Remplacer la photo">Remplacer</button>' +
        '  <button data-act="edit" title="Recadrer">Recadrer</button></div>' +
